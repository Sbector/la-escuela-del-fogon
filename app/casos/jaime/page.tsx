...
export default function JaimePage() {
    return (
        <div className="relative snap-y snap-mandatory h-screen overflow-y-scroll no-scrollbar">
            <Wrapper>
                <h1 className="text-2xl pb-12">¿QUIÉN ES JAIME?</h1>
                <p>Jaime Santiz Gómez nacio en la comunidad de Lelenchij, en Oxchuc, Chiapas</p>
                <p>A los 13 años migró a San Cristóbal de las Casas para continuar sus estudios y trabajar.<br />
                    <br />
                    Actualmente vive con su esposa Rosa y sus hijos en la colonia La Libertad, un área popularmente conocida por el mercado José Castillo Tielmans, el más grande del centro de San Cristóbal.</p>
            </Wrapper>

            <Wrapper>
                <h1 className="text-2xl pb-12">CONFLICTOS Y PARTICULARIDADES DE SU TERRITORIO</h1>
            ...
            <Wrapper>
                <h1 className="text-2xl pb-12">HISTORIA E IMPORTANCIA DE SUS ANAFRES</h1>
            ...
            <Wrapper>
                <h1>1.0 Recolección</h1>
                <PrimerPaso className="size-52" />
            </Wrapper>
        </div>
    )
}
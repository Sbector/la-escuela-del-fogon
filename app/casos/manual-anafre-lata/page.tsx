      ...
      <article className="max-w-4xl mx-auto">
        <header className="mb-8">
          <div className="flex items-center gap-4 mb-2">
            <span className={`${xanhMono.className} text-sm border border-neutral-900 rounded-xl px-1`}>03</span>
            <span className="text-sm uppercase">Proyector • CDMX • Fogón</span>
          </div>
          <h1 className={`${xanhMono.className} text-4xl md:text-5xl mb-6`}>Manual para la elaboración de anafre de lata</h1>
        </header>

        <figure className="mb-8">
          <img
            src="/images/caso4.png"
        ...
        <div className="prose prose-lg max-w-none">
          <h2 className="text-2xl pt-8 pb-16">¿QUIÉN ES JAIME?</h2>
          ...
          <p className="pb-8">
            A los 13 años migró a San Cristóbal de las Casas para continuar sus estudios y trabajar. <br />
            <br />
          ...
          <h2 className="text-2xl pt-8 pb-16">
            CONFLICTOS<br />
            Y PARTICULARIDADES<br />
            DE SU TERRITORIO
          </h2>
          <p className="pb-8">
            La colonia La Libertad alberga “El Tívoli”, un basurero municipal improvisado hace más de 20 años, el cual se ha convertido en un espacio de disputa. <br />
            <br />
          ...
          <p className="pb-8">
            ...
            ---------<br />
            Hoy en día, solo hay 10 personas que practican este oficio, distribuidos en barrios como San Ramón, Tres de Enero, Ojo de Agua, Guadalupe y La Tlaxcala.<br />---------<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
            <img
              ...
              alt="Detalle de anafre tradicional"
              className="w-full h-auto object-cover aspect-video"
            />
            <img
              src="/placeholder.svg?height=300&width=400"
              alt="Anafre en uso durante demostración culinaria"
              className="w-full h-auto object-cover aspect-video"
            />
            <img
              src="/placeholder.svg?height=300&width=400"
              alt="Proceso de elaboración de anafre"
              className="w-full h-auto object-cover aspect-video"
            />
            <img
              src="/placeholder.svg?height=300&width=400"
              alt="Colección de anafres de diferentes tamaños"
              className="w-full h-auto object-cover aspect-video"
            />
          </div> */}

          <div className="flex place-content-between">
                        <Button href="../LEDF_MANUAL_ZINE.pdf" target="_blank">Descargar manual</Button>
                    </div>
        </div>
      </article>
    </main>
